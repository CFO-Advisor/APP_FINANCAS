...
import { Link2, RefreshCw, Loader2, CheckCircle2, AlertCircle, ArrowRight, Wand2 } from 'lucide-react'
      ...
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Rotina posterior à importação: reconhecer que dois lançamentos, em contas diferentes,
            são o mesmo dinheiro saindo de uma e entrando na outra. O vínculo é só reconhecimento —
            não altera saldo nenhum.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <>
          <div className="mb-4 flex flex-wrap items-center gap-3 rounded-lg bg-muted/40 px-3 py-2 text-xs">
            ...
            {pending.length > 0 && (
              <Button size="sm" variant="outline" className="ml-auto gap-1.5 text-xs" onClick={linkAllSuggestions} disabled={busy}>
